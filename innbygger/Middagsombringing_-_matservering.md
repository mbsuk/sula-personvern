...
*   Sikre at pasienter og andre som har behov for å få tilbringet mat får dette på en skikkelig måte. I denne forbindelse har vi behov for bruk av personopplysninger.  
    
*   Kontaktinformasjon(Slik som navn, adresse, telefon og e-post)  
    
*   Helseforhold som er aktuell for saken  
    
*   Helseforhold som kan ha betydning for matserveringen.  
